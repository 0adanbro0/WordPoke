...
document.getElementById('buttonUserWord')?.addEventListener("click", () => {
    let inputUserdefaultWord;
    inputUserdefaultWord = document.querySelector('.inputUserWord');
...
//# sourceMappingURL=main_folder.main.js.map